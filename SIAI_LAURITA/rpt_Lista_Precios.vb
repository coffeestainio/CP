...
Public Class rpt_Lista_Precios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIAA2_CP.rpt_Lista_Precios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Lista_Precios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Lista_Precios = New rpt_Lista_Precios
        rpt.Site = Me.Site
        Return rpt
    End Function
