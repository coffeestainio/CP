...
Public Class rpt_Venta_Cliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIAA2_CP.rpt_Venta_Cliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Venta_Cliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Venta_Cliente = New rpt_Venta_Cliente
        rpt.Site = Me.Site
        Return rpt
    End Function
