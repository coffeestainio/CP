...
Public Class rpt_Puntos_Estado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIAA2_CP.rpt_Puntos_Estado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Puntos_Estado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Puntos_Estado = New rpt_Puntos_Estado
        rpt.Site = Me.Site
        Return rpt
    End Function
