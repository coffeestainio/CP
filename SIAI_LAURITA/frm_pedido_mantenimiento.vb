...
Public Class frm_pedido_mantenimiento
    ...
    Public Sub Identifica_producto()
        ...
        With myForms.frm_pedido
            ...
            If Precio <= 0 Then
                MessageBox.Show("Producto Debe Tener Especificado un Precio", "Pedido", MessageBoxButtons.OK, MessageBoxIcon.Error)
                txtid_producto.Focus()
                SendKeys.Send("{home}+{end}")
                Exit Sub
            End If
    ...
    Public Sub Precio_Calcular()
        ...
        lblconsumidor.Text = FormatNumber(Consumidor, 2)
    End Sub
